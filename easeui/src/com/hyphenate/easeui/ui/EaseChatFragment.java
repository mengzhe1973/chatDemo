...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void initView() {
        ...
        inputMenu.setMoreClick(new OnClickListener() {
            @Override
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            EaseUserUtils.setUserAvatar(getContext(), EMClient.getInstance().getCurrentUser(), titleBar.getRightImage());
        } else {
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    ...
                    if (chatFragmentHelper != null) {
                        chatFragmentHelper.onAvatarClick(EMClient.getInstance().getCurrentUser());
                    }
                } else {
                    toGroupDetails();
                }
    ...
    private void uploadHeadPhoto() {
        ...
        builder.setItems(new String[] { getActivity().getString(R.string.dl_msg_take_photo), getActivity().getString(R.string.dl_msg_local_upload) },
